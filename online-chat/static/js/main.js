...
function sendMessage() {
    console.log('begining of sendMessage func.(after click send)')
    ...
    console.log('end of sendMessage func.')
}
...
function onChatMessage(data) {
    ...
    if(data.type == 'chat_message'){
        ...
        if(data.agent) {
            ...
            `
            console.log('$$first option in "onChatMessage"')
        }else{
            chatLogElement.innerHTML += `
            ...
            `
            console.log('$$second option in "onChatMessage"')
        }
...
async function joinChatRoom(){
    ...
    chatSocket.onopen = function (e) {
        ...
        scrollToBottom()
        console.log('onOpen - befor return.')
    }
